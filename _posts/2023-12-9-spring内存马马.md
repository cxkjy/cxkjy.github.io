...
![image-20231209141148259](..\img\final\image-20231209141148259.png)

往上找一下mappedHandler是什么，往上看，mappedHandler是对handlerMapping进行遍历，

![image-20231209142133699](..\img\final\image-20231209142133699.png)

继续跟进getHandler

![image-20231209142313760](..\img\final\image-20231209142313760.png)

 继续跟进getHandlerInternal里面	

![image-20231209142413817](..\img\final\image-20231209142413817.png)

![image-20231209142429247](..\img\final\image-20231209142429247.png)

上面就是一个调用流程，重要的是这里，mappingRegistry存储了路由信息

![image-20231209142732550](..\img\final\image-20231209142732550.png)
...
![image-20231209143329384](..\img\final\image-20231209143329384.png)
...
![image-20231209143824641](..\img\final\image-20231209143824641.png)

getType获取bean类型，通过isHandler进行类型判断，如果bean类型是controller活着RequestMapping注解，就进入detectHandlerMethods解析bean

![image-20231209144112159](..\img\final\image-20231209144112159.png)

在deletectHandlerMethods中，用getMappingForMethod创建RequestMappingInfo

![image-20231209144502783](..\img\final\image-20231209144502783.png)

处理完后用registryHandlerMethod建立方法到RequestMappingInfo的映射，也就是注册路由

![image-20231209144604915](..\img\final\image-20231209144604915.png)
...
![image-20231209151051697](..\img\final\image-20231209151051697.png)
...
![image-20231209155415424](..\img\final\image-20231209155415424.png)

![image-20231209155652212](..\img\final\image-20231209155652212.png)

该方法从adaptedInterceptors中把符合的拦截器添加到chain里。 adaptedInterceptors就存放了全部拦截器

![image-20231209155702155](..\img\final\image-20231209155702155.png)

返回到DispatcherServlet#doDispatch(),然后执行了applyPreHandle遍历执行了拦截器。

![image-20231209160024874](..\img\final\image-20231209160024874.png)

可以看到里面就是preHandle方法，并且拦截器的下面才是我们的那一串controller东西，所以是先执行拦截器然后执行controller

（D3CTF里面，Boo👨‍🎓也就是利用这个来完成的清空列表黑名单）

![image-20231209160033096](..\img\final\image-20231209160033096.png)

![image-20231209160129104](..\img\final\image-20231209160129104.png)

偷得一张调用流程图，dofilter>拦截器>controller

![image-20231209160422903](..\img\final\image-20231209160422903.png)
...
![image-20231209161404917](..\img\final\image-20231209161404917.png)
...
![image-20231209162412105](..\img\final\image-20231209162412105.png)
...
![image-20231209163610787](..\img\final\image-20231209163610787.png)

第一次访问不会执行preHandler，第二次访问才会执行

![image-20231209165500361](..\img\final\image-20231209165500361.png)

可以发现

![image-20231209170431455](..\img\final\image-20231209170431455.png)

![image-20231209170446434](..\img\final\image-20231209170446434.png)

下面是判定流程

![image-20231209170633996](..\img\final\image-20231209170633996.png)

![image-20231209170717802](..\img\final\image-20231209170717802.png)
...
![image-20231209174050044](..\img\final\image-20231209174050044.png)
