...
![image-20230920220849788](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230920220849788.png)

![image-20230920220859458](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230920220859458.png)
...
![image-20230921152224928](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921152224928.png)
...
![image-20230921153330264](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921153330264.png)
...
![image-20230921153721026](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921153721026.png)

但是在构造的时候遇到了一个麻烦

这里AnnotationInvocationhandler是一个class类这是为啥呢，

![image-20230921154235163](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921154235163.png)

首先这个类是一个有参的方法，其次forName反射需要newinstance进行实例化

![image-20230921154611596](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921154611596.png)
...
![image-20230921203009887](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921203009887.png)
...
![image-20230921204537542](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921204537542.png)
...
![image-20230921204735241](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921204735241.png)

发现是一个ResultSet接口

![image-20230921205040610](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921205040610.png)

![image-20230921205053675](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921205053675.png)

然后进入ResultSetImpl方法，就是一个反序列化readObject

![image-20230921205158546](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921205158546.png)

### 正式回归题目

根据上面的为基础，我们现在只需要想如何调用到connect()方法

![image-20230921205746870](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921205746870.png)

那么这里就要用到动态代理了，其实它这道题能用到动态代理的点主要在于这里触发了 info.getAllInfo()方法

![image-20230921210247696](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921210247696.png)

那么就触发了动态代理就会进一步触发到了 invoke，

触发动态代理的checkAllInfo()方法

![image-20230921210853614](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921210853614.png)

继续触发checkAllInfo()方法，里面调用了connect方法

![image-20230921210920528](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921210920528.png)

然后之后的过程就和上面连起来了

![image-20230921211054506](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921211054506.png)
...
![image-20230921211305705](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921211305705.png)

![image-20230921213114666](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921213114666.png)
...
![image-20230921213152235](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230921213152235.png)
...
![image-20230922123848703](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230922123848703.png)

然后刷新浏览器，打到恶意mysql服务器上，bps开启监听

![image-20230922123946409](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230922123946409.png)
...
![image-20230923145732298](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230923145732298.png)
...
![image-20230923160437657](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230923160437657.png)

`还有一种可能就是，代理直接改成题目那个的`

怎么写都是空指针异常了。。。

![image-20230923161829964](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230923161829964.png)
...
![image-20230923163656966](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230923163656966.png)

![image-20230923163736712](C:\Users\c'x'k\AppData\Roaming\Typora\typora-user-images\image-20230923163736712.png)	
